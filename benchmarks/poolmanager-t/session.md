...
```json
{
  "diagnostics": [
    {
      "code": "6275",
      "message": "ParserError: Source \"forge-std/Test.sol\" not found: File not found. Searched the following locations: \"/Users/meek/developer/mmsaki/solidity-language-server/v4-core\", \"/Users/meek/developer/mmsaki/solidity-language-server/v4-core/node_modules\".\n  |\n4 | import {Test} from \"forge-std/Test.sol\";\n  | ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^",
      "range": {
        "end": {
          "character": 40,
          "line": 3
...
```json
{
  "diagnostics": [
    {
      "code": "6275",
      "message": "Source \"forge-std/Test.sol\" not found: File not found. Searched the following locations: \"\".",
      "range": {
        "end": {
          "character": 40,
          "line": 3
